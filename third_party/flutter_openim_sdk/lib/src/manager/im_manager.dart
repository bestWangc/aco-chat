...
class IMManager {
  ...
  /// Prevent Android's activity lifecycle hook from switching OpenIM to push
  /// mode while the host app owns a foreground messaging service.
  Future<void> setKeepConnectionsAliveWhenInBackground({
    required bool enabled,
  }) async {
    if (!Platform.isAndroid) return;
    await _channel.invokeMethod<void>(
      'setKeepConnectionsAliveWhenInBackground',
      _buildParam({'enabled': enabled}),
    );
  }
