...
public class IMManager extends BaseManager {
    ...
    public void setKeepConnectionsAliveWhenInBackground(MethodCall methodCall, MethodChannel.Result result) {
        Boolean enabled = methodCall.argument("enabled");
        FlutterOpenimSdkPlugin.keepConnectionsAliveWhenInBackground = enabled != null && enabled;
